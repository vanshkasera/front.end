...
function NavBar(){
    return(
        ...
        <div style={{backgroundColor: '#a2a2a2' ,color:'#07588a',zIndex:10}}>
                ...
                <div className="container-fluid  ">
                  ...
                  <div className="collapse navbar-collapse  " id="navbarSupportedContent">
                    ...
                    <div className="navbar-nav mb-2 ms-5 ">
                      ...
                      <li className="nav-item">
                        {/* this link will show the Contact Us page. */}
                        <Link to='/contact' className="nav-link active" style={{textDecoration:'none',color:'#07588a',fontSize:"20px"}}>Contact Us</Link>
                      </li>
                      <li className="nav-item">
                        {/* this link will show the Contact Us page. */}
                        <Link to='/login' className="nav-link active" style={{textDecoration:'none',color:'#07588a',fontSize:"20px"}}>Log In</Link>
                      </li>
